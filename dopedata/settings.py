"""
Django settings for dopedata project.
...
SECRET_KEY = 'k#+daxffgqn)y4*vkluzv9k(_8u4jg4_92!thqi#1tnn(h-b2q'
...
WSGI_APPLICATION = 'dopedata.wsgi.application'
